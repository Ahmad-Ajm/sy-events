    ...
    public partial class AddEventKindColumn : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                newName: "IX_HomeSliderItems_IsActive");

            migrationBuilder.RenameIndex(
                name: "IX_home_slider_items_DisplayOrder",
                table: "HomeSliderItems",
                newName: "IX_HomeSliderItems_DisplayOrder");

            migrationBuilder.RenameIndex(
                name: "IX_home_slider_items_CustomEventId",
                table: "HomeSliderItems",
                newName: "IX_HomeSliderItems_CustomEventId");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HiddenReason = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkedInUrl = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    TwitterHandle = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    FacebookUrl = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    ...
                    EventsAttendedCount = table.Column<int>(type: "integer", nullable: false),
                    EventsOrganizedCount = table.Column<int>(type: "integer", nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendeeMeetings_MeetingTime",
                table: "AttendeeMeetings",
                column: "MeetingTime");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendeeMeetings_Status",
                table: "AttendeeMeetings",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventDiscussions_IsHidden",
                table: "EventDiscussions",
                column: "IsHidden");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventDiscussions_UserId",
                table: "EventDiscussions",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_EventFiles_DisplayOrder",
                table: "EventFiles",
                column: "DisplayOrder");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_HomeSliderItems_Events_CustomEventId",
                table: "HomeSliderItems",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                name: "IX_HomeSliderItems_IsActive",
                table: "home_slider_items",
                newName: "IX_home_slider_items_IsActive");

            migrationBuilder.RenameIndex(
                name: "IX_HomeSliderItems_DisplayOrder",
                table: "home_slider_items",
                newName: "IX_home_slider_items_DisplayOrder");

            migrationBuilder.RenameIndex(
                name: "IX_HomeSliderItems_CustomEventId",
                table: "home_slider_items",
                newName: "IX_home_slider_items_CustomEventId");
