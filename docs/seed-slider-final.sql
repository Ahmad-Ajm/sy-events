-- إضافة عناصر سلايدر (5 عناصر نشطة)
INSERT INTO home_slider_items ("DisplayOrder", "Type", "CustomEventId", "IsActive", "Title", "TitleEn", "ImageUrl", "ExtraProperties", "ConcurrencyStamp", "CreationTime", "IsDeleted") VALUES
(1, 1, NULL, true, 
